      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-10 pt-14 lg:pt-0">
        ...
        <div className="pt-6 sm:pt-8 lg:pt-12 pb-6 sm:pb-8 border-b border-border-default">
          ...
          >
            ...
            <h1 className="text-2xl font-bold tracking-tight text-text-primary">
              MPS Component Library
            </h1>
            <p className="mt-2 text-sm text-text-muted max-w-lg">
              A living reference for the reusable components, tokens, and
              patterns powering the MPS waste shipment platform.
            </p>
          </motion.div>
        </div>
        ...
        <Section id="colors" title="Color Palette" description="Brand, neutral, and semantic color tokens.">
          <Sub title="Primary">
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-8 gap-3">
              ...
              <Swatch label="300" hex="#4F89B8" className="bg-primary-300" />
              <Swatch label="400" hex="#2C6A96" className="bg-primary-400" />
              <Swatch label="500" hex="#1E4F73" className="bg-primary-500" />
              <Swatch label="600" hex="#163A52" className="bg-primary-600" />
              <Swatch label="700" hex="#0F2A3D" className="bg-primary-700" />
            </div>
          </Sub>
          ...
          <Sub title="Secondary">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              <Swatch label="600" hex="#1F3F36" className="bg-secondary-600" />
            </div>
          </Sub>
          ...
          <Sub title="Neutral">
            <div className="grid grid-cols-3 sm:grid-cols-6 md:grid-cols-11 gap-2">
              ...
              <Swatch label="300" hex="#C2CBD3" className="bg-gray-300" />
              <Swatch label="400" hex="#95A2AD" className="bg-gray-400" />
              <Swatch label="500" hex="#6F7C87" className="bg-gray-500" />
              <Swatch label="600" hex="#55606A" className="bg-gray-600" />
              <Swatch label="700" hex="#3E454C" className="bg-gray-700" />
              <Swatch label="800" hex="#2B3137" className="bg-gray-800" />
              <Swatch label="900" hex="#1A1F24" className="bg-gray-900" />
              <Swatch label="950" hex="#0E1114" className="bg-gray-950" />
            </div>
          </Sub>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
            <DemoBox className="space-y-5">
              <Sub title="Text Input">
                <div className="space-y-3">
                  <FormField label="Site Name" htmlFor="site" required>
                    <TextInput id="site" placeholder="Enter site name" />
                  </FormField>
                  <FormField label="Email" htmlFor="email-err" error="Please enter a valid email">
                    <TextInput id="email-err" placeholder="user@mps.com" error defaultValue="bad-email" />
                  </FormField>
              ...
              <Sub title="Number Input">
                <div className="space-y-3">
                  <FormField label="Weight" htmlFor="weight">
                    <NumberInput id="weight" placeholder="0.00" suffix="lbs" />
                  </FormField>
                  <FormField label="Cost" htmlFor="cost">
                    <NumberInput id="cost" placeholder="0.00" prefix="$" />
                  </FormField>
                </div>
              </Sub>
        ...
        <div className="py-10 text-center">
          <p className="text-xs text-text-muted">
            MPS Design System v1.0 &middot; Radix UI + Tailwind v4 + Motion
          </p>
        </div>
      </main>
    </div>
